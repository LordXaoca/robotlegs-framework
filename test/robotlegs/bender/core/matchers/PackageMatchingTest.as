...
package robotlegs.bender.core.matchers
{
	...
	import robotlegs.bender.core.matchers.support.a.PackagedTypeA;
	import robotlegs.bender.core.matchers.support.b.PackagedTypeB;
	import robotlegs.bender.core.matchers.support.c.PackagedTypeC;

	public class PackageMatchingTest
	{
		private var instance:PackageMatcher;

		private const PACKAGE_A:String = "robotlegs.bender.core.matchers.support.a";

		private const PACKAGE_B:String = "robotlegs.bender.core.matchers.support.b";

		private const PACKAGE_C:String = "robotlegs.bender.core.matchers.support.c";

		private const PARENT_PACKAGE:String = "robotlegs.bender.core.matchers.support";
		...
		[Test(expects='robotlegs.bender.core.matchers.TypeMatcherError')]
